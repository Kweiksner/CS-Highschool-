...
def main(): 
    while True: 
        data= input("Welcome to post office please eter Enter DATA (legnth, height, thickness, your staring zip code and the zipcode you are shipping too): ")          #has the user enter the sizes of the boxes
        ...
        if len(data)!= 5: 
            ...
            try: 
                length = float(data[0])                                      # height is the first thing that they enter 
                height = float(data[1])                                     # length is the second thing that they enter
